...
A real deployment must independently own Cloudflare Worker and D1 configuration, migration execution, exact website-origin CORS, APNs token credentials, backup and rollback policy, tier-aware encrypted recovery and retention, abuse controls, monitoring, security updates, and user-facing support/privacy/deletion surfaces.
